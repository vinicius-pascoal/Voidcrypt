# Ideias de Melhorias - Voidcrypt

V
## 1. Progressao de run
1. Reliquias passivas por piso, como +1 alcance de ataque e +10% chance de critico.
2. Escolha entre 2 recompensas ao concluir cada piso.
3. Mini-chefes a cada 3 pisos para marcar picos de dificuldade.

V
## 2. Combate mais profundo
1. Tipos de inimigo com IA distinta: perseguidor, arqueiro, tanque e invocador.
2. Sistema de stamina, em que ataque forte gasta mais e esperar recupera.
3. Telegraph de ataque inimigo, com sinal visual antes do golpe.
4. animacoes de movimentacao

V
## 3. Loot e economia
1. Loja entre pisos para gastar shards.
...
3. Tela de game over com resumo da run: piso, kills, tempo e loot.

## Sugestao de fases
1. Fase 1 (alto impacto rapido): loja simples, 2 tipos de inimigo, camera shake, minimap.
2. Fase 2 (profundidade): reliquias, stamina e salas especiais.
3. Fase 3 (longevidade): classes.
